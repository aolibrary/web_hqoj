    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <?php } else { ?>
                    <a href="/setup_problem_detail/?global-id=<?php echo $problemInfo['id']; ?>"><?php echo $problemInfo['title']; ?></a>
                <?php } ?>
            </td>
...
<script>
    seajs.use(['jquery', 'notice'], function($, notice) {
        ...
        $('input[name=add-problem]').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: '/setup_contest_setProblem/ajaxAddProblem/',
                type: 'post',
                dataType: 'json',
                data: {
        ...
        $('a[name=remove]').click(function(e) {
            e.preventDefault();
            $.ajax({
                url: '/setup_contest_setProblem/ajaxRemoveProblem/',
                type: 'post',
                dataType: 'json',
                data: {
