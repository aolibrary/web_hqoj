...
<div class="mb10 p10 tc f16 fw">实时状态（管理员模式）</div>
...
<table class="mt10 mb10 widget-table widget-table-hover status">
    <thead>
        <tr>
            ...
            <th class="tc" width="6%">时间</th>
            <th class="tc" width="6%">内存</th>
            <th class="tc" width="6%">代码</th>
            <th class="tc" width="6%">语言</th>
            <th width="7%">权限</th>
            <th width="6%">竞赛</th>
            <th class="tc" width="12%">提交者</th>
        </tr>
    </thead>
    <tbody>
        <?php
        ...
        <tr>
            ...
            <td><?php echo $solutionInfo['contest_id'] ? $solutionInfo['contest_id'].':'.$solutionInfo['contest_submit_order'] : '-'; ?></td>
